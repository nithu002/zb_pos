...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('app.products.create', compact('categories', 'units', 'locations', 'variants'));
    }
    ...
    {
        //
        $product = product::with('cate')->with('supply')->findOrFail($id);
        $categories = Category::all();
        $units = Unit::all();
        $locations = Location::all();
        $variants = Variant::all(['id', 'name', 'values']);
        return view('app.products.edit', compact('categories', 'units', 'locations', 'variants', 'product'));
    }
