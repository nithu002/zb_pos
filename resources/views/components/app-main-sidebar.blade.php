				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						<li class="submenu-open">
							...
							<ul>
                                <li><a href="product-list.html"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Dashboard</span></a></li>
							</ul>
						</li>
						<li class="submenu-open">
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="{{url('customer-view')}}"><i class="ti ti-users-group fs-16 me-2"></i><span>Customers</span></a></li>
								{{-- <li><a href="{{url('billers-view')}}"><i class="ti ti-user-up fs-16 me-2"></i><span>Billers</span></a></li> --}}
								<li><a href="{{url('supplier-view')}}"><i class="ti ti-user-dollar fs-16 me-2"></i><span>Suppliers</span></a></li>
