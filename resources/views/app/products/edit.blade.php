                    ...
                    <div class="accordions-items-seperate" id="accordionSpacingExample">
                        <div class="accordion-item border mb-4">
                                    ...
                                    {{-- <div class="row">
											<div class="col-sm-6 col-12">
												<div class="mb-3">
													...
													<input name="slug" value="{{ old('slug',$product->slug ?? '') }}" type="text" class="form-control">
												</div>
											</div>
                                            <div class="col-sm-6 col-12">
													<div class="mb-3">
                                                        ...
                                                        <select name="location" class="form-select">
                                                            ...
                                                            @forelse ($locations as $location)
                                                                <option value="{{ $location->name }} "
                                                                    @if ($location->name == $product->location) selected @endif>
                            ...
                            <div class="accordion-item border mb-4">
                                ...
                                <div id="SpacingThree" class="accordion-collapse collapse @if(isset($product->images)) show @endif "
                                                        ...
                                                        @if(!empty($images))
                                                            @foreach($images as $img)
                                                                <div class="phone-img uploaded" style="position:relative; display:inline-block; margin:5px;">
                                                                    <img src="{{ $img }}" alt="image" style="max-width:110px; max-height:110px; border-radius:8px; box-shadow:0 2px 8px #eee;">
                            ...
                            <div class="accordion-item border mb-4">
                                ...
                                <div id="SpacingFour" class="accordion-collapse collapse @if(isset($product->manufacturer) || isset($product->expiry_date) || isset($product->manufacturer_date)) show @endif "
                                        ...
                                        <div>
                                            <div class="p-3 bg-light rounded d-flex align-items-center border mb-3">
                                                <div class=" d-flex align-items-center">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" @if(isset($product->expiry_date)) checked @endif type="checkbox" id="manufacturer"
                                                            value="option2">
                                                        <label class="form-check-label"
                                                            for="manufacturer">Manufacturer</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" @if(isset($product->manufacturer_date)) checked @endif type="checkbox" id="expiry"
                                                            value="option2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-12 manufacturer">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-groupicon calender-input">
                                                            ...
                                                            <input type="text" value="{{ old('manufacturer_date',$product->manufacturer_date ?? '') }}"  name="manufacturer_date"
                                                ...
                                                <div class="col-sm-6 col-12 expiry_date">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-groupicon calender-input">
                                                            <i data-feather="calendar" class="info-img"></i>
                                                            <input name="expiry_date" value="{{ old('expiry_date',$product->expiry_date ?? '') }}" type="text"
                                                                class="datetimepicker form-control"
                                                                placeholder="dd/mm/yyyy">
                                                        </div>
                                                    </div>
